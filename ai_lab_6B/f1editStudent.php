...
<body>
    ...
    <div class="container">
        ...
        <form action="f1action.php" method="POST">
            <br>
            <h4>Edytowanie danych studenta</h4>
            ...
            <div class="form-group">
                <label for="adresInput">Wybierz adres: </label>
                <?php $db->selectAdres(); ?>
            </div>

            <input type="hidden" id="idInput" name="id" value="<?php echo $id ?>">

            <input type="submit" class="btn btn-info" name="updateStudent" value="Edytuj dane studenta">
        </form>
    </div>
