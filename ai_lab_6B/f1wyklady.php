...
<body>
    ...
    <div class="container">
        ...
        <form action="f1action.php" method="POST">
            <br>
            <h4>Wprowadzanie danych wykładu</h4>
            <div class="form-group">
                <label for="nazwaInput">Podaj nazwę: </label>
                <input type="text" class="form-control" id="nazwaInput" name="nazwa" placeholder="Wpisz nazwę (np. Aplikacje internetowe)" required>
            </div>

            <input type="submit" class="btn btn-primary mb-2" name="insertWyklad" value="Wprowadź dane wykładu">
            <input type="reset" class="btn btn-warning mb-2" value="Wyczyść formularz">
        </form>

        <h4>Dane wykładów</h4>
        <?php $db->getTableWyklady(); ?>
    </div>
