...
<body>
    ...
    <div class="container">
        ...
        <form action="e12action.php" method="POST">
            <br>
            <h4>Formularz dodawania nowego studenta</h4>
            ...
            <input type="submit" class="btn btn-primary mb-2" name="insertStudent" value="Dodaj studenta">
        ...
        <form action="e12action.php" method="POST">
            <input type="submit" class="btn btn-danger" name="dropTable" value="Usuń wszystkich studentów!">
        </form>
    </div>
